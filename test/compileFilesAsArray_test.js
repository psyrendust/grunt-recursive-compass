...
exports['recursive-compass'] = {
  ...
  compileFilesAsArray: function(test) {
    ...
    test.equal(compile_actual, compile_expected, "should compile compile.scss to compile.css using Files as an Array");

    var foo_actual = grunt.file.read('test/fixtures/test/foo.css');
    var foo_expected = grunt.file.read('test/expected/foo_default.css');
    test.equal(foo_actual, foo_expected, "should compile foo.scss to foo.css using Files as an Array");
    ...
    test.equal(test_actual, test_expected, "should compile test.scss to test.css using Files as an Array");
